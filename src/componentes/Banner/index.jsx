...
const Banner = () => {
  ...
  const cardShadowStyle = {
    boxShadow: `0px 0px 17px 4px ${colors[video.category] || '#7a6bff'}`,
    borderColor: colors[video.category] || '#7a6bff',
  };
    ...
    <div className={styles.bannerStyled}>
      <div className={styles.card}>
        <div className={styles.cardContentLeft}>
          <div className={`${styles.titleContainer} ${styles.cardTitle}`} style={{ backgroundColor: colors[video.category] || '#7a6bff' }}>
            {video.category}
          </div>
